...
Array.from(document.getElementsByClassName('json')).forEach(function(element){
    CodeMirror(function(elt) {
        element.parentNode.replaceChild(elt, element);
    }, {mode: 'application/json',value: element.textContent,'readOnly': "nocursor",lineNumbers: true,matchBrackets:true,viewportMargin:Infinity,autofocus:true});
